...
export const metadata = { title: 'Terms of Service — Romdott' };
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="font-sans space-y-8 text-soft-black/80 leading-relaxed">
          <section>
            ...
            <p>Romdott is a roommate-matching platform. We help you find compatible people to live with. We do not provide housing, accommodation, or any listings. Any housing arrangements are made directly between users.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-soft-black mb-3">Eligibility</h2>
            <p>You must be 18 or older to use Romdott. By signing up, you confirm that you are 18+. The platform is currently available to residents and visitors of EU, EEA, UK, and Switzerland only.</p>
          </section>
          ...
          <section>
            ...
            <p>You own the content you post. By uploading photos or writing prompts, you grant Romdott a limited license to display them to other users for matching purposes only. We do not use your content for advertising or AI training.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-soft-black mb-3">Beta period</h2>
            <p>Romdott is currently in beta. The service is provided free of charge and as-is. Features may change. We may limit access or shut down the beta at any time with reasonable notice.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-soft-black mb-3">Limitation of liability</h2>
            <p>Romdott facilitates introductions between adults. We are not responsible for any outcomes of roommate arrangements, disputes, or interactions that take place outside the platform. Exercise your own judgment and take normal precautions when meeting new people.</p>
          </section>
